    ...
    export default {
        data() {
            return {
                ...
                amexCardMask: "#### ###### #####",
                otherCardMask: "#### #### #### ####",
                cardNumberTemp: "0000 0000 0000 0000",
                isCardFlipped: false,
        ...
        methods: {
            ...
            async checkPayment() {
                ...
                const responce = await axios.post("/payment", this.form)
        ...
        <div class="card-form">
            ...
            <div class="card-item" v-bind:class="{ '-active' : isCardFlipped }">
                ...
                <div class="card-item__wrapper">
                    ...
                    <template v-if="getCardType === 'amex'">
                        ...
                        <transition name="slide-fade-up">
                            ...
                            v-if="$index > 4 && $index < 14 && form.cardNumber.length > $index && n.trim() !== ''">*</div>
                    ...
                    <template v-else>
                        ...
                        <transition name="slide-fade-up">
                            <div class="card-item__numberItem"
                            v-if="$index > 4 && $index < 15 && form.cardNumber.length > $index && n.trim() !== ''">*</div>
                            <div class="card-item__numberItem" :class="{ '-active' : n.trim() === '' }" :key="$index"
                            v-else-if="form.cardNumber.length > $index">
                            {{form.cardNumber[$index]}}
                            </div>
                    ...
                    <label for="cardName" class="card-item__info" ref="cardName">
                        ...
                        <transition name="slide-fade-up">
                        <div class="card-item__name" v-if="form.cardName.length" key="1">
                            <transition-group name="slide-fade-right">
                            <span class="card-item__nameItem" v-for="(n, $index) in form.cardName.replace('/\s\s+/g', ' ')"
                    ...
                    <div class="card-item__date" ref="cardDate">
                        ...
                        <transition name="slide-fade-up">
                            <span v-if="form.cardMonth" v-bind:key="form.cardMonth">{{form.cardMonth}}</span>
                        ...
                        <transition name="slide-fade-up">
                            <span v-if="form.cardYear" v-bind:key="form.cardYear">{{String(form.cardYear).slice(2,4)}}</span>
                ...
                <div class="card-item__cvv">
                    ...
                    <span v-for="(n, $index) in form.cardCvv" :key="$index">
                        *
                    </span>
                    </div>
                    <div class="card-item__type">
            ...
            <div class="card-form__inner">
                <form @submit.prevent="onSubmit" @submit="checkPayment()">
                    <div class="card-input">
                        ...
                        v-model="form.cardNumber" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardNumber" autocomplete="off">
                    </div>
                    <div class="card-input">
                        <label for="cardName" class="card-input__label">Владелец карты</label>
                        <input type="text" id="cardName" class="card-input__input" v-model="form.cardName" v-on:focus="focusInput"
                        v-on:blur="blurInput" data-ref="cardName" autocomplete="off">
                    </div>
                    <div class="card-form__row">
                        <div class="card-form__col">
                        <div class="card-form__group">
                            <label for="cardMonth" class="card-input__label">Время действия</label>
                            <select class="card-input__input -select" id="cardMonth" v-model="form.cardMonth" v-on:focus="focusInput"
                            ...
                            <select class="card-input__input -select" id="cardYear" v-model="form.cardYear" v-on:focus="focusInput"
                            v-on:blur="blurInput" data-ref="cardDate">
                        ...
                        <div class="card-input">
                            ...
                            <input type="text" class="card-input__input" id="cardCvv" v-mask="'###'" maxlength="3" v-model="form.cardCvv"
